    ...
    if(isset($_POST["metric"])) {
      ...
      foreach($g as $k => $v) {
        ...
        if(in_array($k, $editable_ids)) {
          array_push($data, array("id"=>$k, "metric_title"=>$v, "canedit"=>"true", "updated"=>$update));
        } else {
          array_push($data, array("id"=>$k, "metric_title"=>$v, "canedit"=>"false", "updated"=>$update));
        }
      }
      curl_setopt($ch, CURLOPT_RETURNTRANSFER, true);
    ...
    <meta content='width=device-width, initial-scale=1.0, maximum-scale=1.0, user-scalable=0' name='viewport' />
      ...
      $(document).ready(function(){
        ...
        for(d in departments) {
          prog_mapping[departments[d]["id"]] = departments[d]["department"];
        }
        var table = "";
        for(d in data) {
          table += "<tr>";
          ...
          table += "<td>" + prog_mapping[data[d]["department"]] + "</td>";
              ...
              <div class="container-fluid">
                <div class="row">
                    <div class="col-md-12">
                        <div class="card">
                          <div class="content">
                            <input name="allowChange" type="checkbox" /> Allow Program Admins to Alter All Metric Names and Targets
                          </div>
                        </div>
                      </div>
                    </div>
